...
underlay
     ...
     --------------------------------external---------------------------------
           ...
           |             |              |             |             |
      -----------   ------------   -----------   ------------  -----------
      | ovn-hv2  | | ovn-ctrl  |  | ovn-hv1   | |  ovn-gw1  | |  ovn-gw2  |
      -----------   ------------   -----------   ------------  -----------
           |             |              |             |             |
           |             |              |             |             |
     -------------------------------------------------------------------------
...
- 逻辑交换机上的localnet端口在每个chassis上都存在，因此每个chassis上都要设置localnet
- 物理网络中的主机bm1可以通过dhcp从ha_chassis_group上获取ip地址，ha_chassis_group中一个chassis失效后另一个chassis会自动激活提供服务
