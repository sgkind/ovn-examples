...
dhcptemp=`ovn-nbctl create DHCP_Options cidr=192.168.1.0/24 options="\"server_id\"=\"192.168.1.1\" \"server_mac\"=\"02:ac:10:ff:01:29\" \"lease_time\"=\"36000\" \"router\"=\"192.168.1.1\""`
ovn-nbctl lsp-add internal1-switch ext-bm1
ovn-nbctl lsp-set-addresses ext-bm1 "02:ac:10:ff:01:03 192.168.1.5/24"
ovn-nbctl lsp-set-type ext-bm1 external
ovn-nbctl lsp-set-dhcpv4-options ext-bm1 $dhcptemp

ovn-nbctl ha-chassis-group-add hagrp 
ovn-nbctl ha-chassis-group-add-chassis hagrp gw1 30
ovn-nbctl ha-chassis-group-add-chassis hagrp gw2 20

ovn-nbctl set Logical_Switch_port ext-bm1 ha-chassis-group=`ovn-nbctl --bare --columns _uuid find ha_chassis_group name=hagrp`
