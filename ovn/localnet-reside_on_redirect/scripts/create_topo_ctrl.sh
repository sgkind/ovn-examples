...
ovn-nbctl set Logical_Router_Port internal1-port options:reside-on-redirect-chassis=true
ovn-nbctl lrp-add R1 internal2-port 00:00:01:01:02:04 192.168.2.1/24
ovn-nbctl set Logical_Router_Port internal2-port options:reside-on-redirect-chassis=true
...
ovn-nbctl lsp-set-options internal1-localnet network_name=ext
...
ovn-nbctl lsp-set-options internal2-localnet network_name=ext
