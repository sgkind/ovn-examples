...
ovn-nbctl lsp-add external-switch test-localnet "" 30
ovn-nbctl lsp-set-addresses test-localnet unknown
ovn-nbctl lsp-set-type test-localnet localnet
ovn-nbctl lsp-set-options test-localnet network_name=ext1

ovn-nbctl lr-add R1
ovn-nbctl lrp-add R1 internal1-port 00:00:01:01:02:03 192.168.1.1/24 
ovn-nbctl lrp-set-redirect-type internal1-port bridged
ovn-nbctl lrp-add R1 internal2-port 00:00:01:01:02:04 192.168.2.1/24
ovn-nbctl lrp-set-redirect-type internal2-port bridged
...
#ovn-nbctl lrp-set-redirect-type external-port bridged
