...
ovn-nbctl lrp-add GR_gateway rtoj-GR_gateway 0a:58:64:40:00:02 100.64.0.2/16

# add ports to join switch
ovn-nbctl lsp-add join jtor-GR_gateway \
    -- lsp-set-type jtor-GR_gateway router \
    -- lsp-set-addresses jtor-GR_gateway router \
    -- lsp-set-options jtor-GR_gateway router-port=rtoj-GR_gateway
ovn-nbctl lsp-add join jtor-ovn_cluster_router \
    -- lsp-set-type jtor-ovn_cluster_router router \
    -- lsp-set-addresses jtor-ovn_cluster_router router \
    -- lsp-set-options jtor-ovn_cluster_router router-port=rtoj-ovn_cluster_router

# add ports to ovn_cluster_router
ovn-nbctl lrp-add ovn_cluster_router rtoj-ovn_cluster_router 0a:58:64:40:00:01 100.64.0.1/16
